...
const dashUsuarios = async (req, res) => {
  ...
  try {
    ...
    let datosUsuarios = {};
    await fetch(url, option).then(response => response.json()).then(datosU => {
  ...
  if (req.body.COD_USUARIO) {
    ...
    if (datosUsuario.DNI_USUARIO && datosUsuario.NOM_USUARIO && datosUsuario.APELL_USUARIO && datosUsuario.CORREO && datosUsuario.CONTRASENA && datosUsuario.FECHA_NAC && datosUsuario.SEXO && datosUsuario.ESTADO && datosUsuario.COD_ROL) {
      try {
        ...
        await fetch(url, option).then(response => response.json()).then(resRegistro => {
...
const eliminarUsuario = async (req, res) => {
  ...
  const result = await fetch(url, option).then(response => response.json()).then(data => {
...
const dashLibros = async (req, res) => {
  ...
  try {
    ...
    let datosLibros = {};
    await fetch(url, option).then(response => response.json()).then(datosL => {
      datosLibros = datosL;
...
const dashPrestamos = async (req, res) => {
  try {
    ...
    let dataPrestamo = {};
    await fetch(url, option).then(response => response.json()).then(datosP => {
      dataPrestamo = datosP;
